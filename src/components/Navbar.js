...
const Navbar = () => {
  ...
  return (
    <div className='bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between w-full z-10 fixed'>
        <div className='flex justify-between items-center'>
            <div className='text-yt-white p-2 w-10 text-center hover:bg-yt-light-black rounded-full cursor-pointer'>
                <HiOutlineBars3 size='1.5rem'/>  
              </div>
              <div className='py-5 w-20 pr-30'>
                  <Link to="/" >
                      <img src={logo} alt='lg'/>
                  </Link>
              </div>
